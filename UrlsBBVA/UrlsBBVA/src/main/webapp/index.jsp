                        ...
                        <div class="col-lg-12">
                            ...
                            <div id="peticionDiv" class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-offset-1" action="" method="post">
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1"></span>
                                                <input type="text" class="form-control" placeholder="Concepto" aria-describedby="basic-addon1">
                                            </div>
                                            <br>
                                            <div class="form-inline">
                                                <button onclick="consultarPorPeticion()" class="btn btn-success btn-sm" >Aceptar</button>
